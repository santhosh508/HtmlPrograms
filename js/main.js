...
(function ($) {
    ...
    ===========================================================*/
        ...
        $('#tab1').on("click", function(){
            $('#gotab1').animatescroll({scrollSpeed:2000,easing:'easeInOutBack'});
        });

        $('#tab2').on("click", function(){
            $('#gotab2').animatescroll({scrollSpeed:2000,easing:'easeInOutBack'});
        });

        $('#tab3').on("click", function(){
            $('#gotab3').animatescroll({scrollSpeed:2000,easing:'easeInOutBack'});
        });

        $('#tab4').on("click", function(){
            $('#gotab4').animatescroll({scrollSpeed:2000,easing:'easeInOutBack'});
        });

        $('#tab5').on("click", function(){
            $('#gotab5').animatescroll({scrollSpeed:2000,easing:'easeInOutBack'});
        });

        $('#tab6').on("click", function(){
            $('#gotab6').animatescroll({scrollSpeed:2000,easing:'easeInOutBack'});
        });

        $('#tab7').on("click", function(){
            $('#gotab7').animatescroll({scrollSpeed:2000,easing:'easeInOutBack'});
        });

        $('#tab8').on("click", function(){
            $('#gotab8').animatescroll({scrollSpeed:2000,easing:'easeInOutBack'});
        });
